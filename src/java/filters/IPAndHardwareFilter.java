...
import models.ClientInfoHandler;
 ...
 * @author Andrew
 */
public class IPAndHardwareFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        // Get the IP address of client machine, current date, and the requested URI.   
        String ip = req.getRemoteAddr();
        String date = new Date().toString();
        String page = req.getRequestURI();
        String browser = HTMLFilter.filter(req.getHeader("User-Agent"));
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("IPAndHardwareFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("IPAndHardwareFilter:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("IPAndHardwareFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("IPAndHardwareFilter()");
        }
        StringBuffer sb = new StringBuffer("IPAndHardwareFilter(");
